  ...
  return (
    <div id='home' className='px-20 max-md:px-5 transition-all duration-700'>
      <div className='flex justify-between pt-36 max-md:pt-10 max-md:flex-col max-md:gap-20 items-center '>
        <div>
          <h1 className='text-white text-[25px] font-bold max-md:text-[20px]'>Hello It's Me</h1>
          <h1 className='text-white text-[45px] font-bold max-md:text-[35px]'>Mohab Mohamed</h1>
          <h1 className='text-white text-[25px] font-bold max-md:text-[20px]'>And I'm A <span className='text-green-500 animate-pulse'>Frontend Developer</span></h1>
          <p className='text-white text-[15px] max-md:mt-10 max-w-[360px] mt-5 text-justify'>
